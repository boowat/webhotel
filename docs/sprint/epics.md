...
- **Epic** = "Part of" di Notion — area fitur besar
- **Story** = user story ("As a ... I want ... So that ...")
- **Task** = "Children Tasks" di Notion, di-assign ke satu orang, dicentang kalau selesai
- Update task/story ini kapan aja progress berubah — bukan cuma pas standup
- Status: ⚪ Not Started · 🟡 In Progress · 🟢 Done · 🔴 Blocked

Tambah Epic/Story baru kalau ada export Notion baru. Task boleh ditambah bebas di bawah story yang relevan.
...
- [ ] Task: [Nama] — Integrasi Submit & API State — ⚪
- [ ] Task: [Nama] — Setup Server-Side Validation (Zod) — ⚪
- [ ] Task: [Nama] — Implement Database Transaction — ⚪
- [ ] Task: [Nama] — Create Guests Table — ⚪
- [ ] Task: [Nama] — Wireframe Search Result — ⚪
- [ ] Task: [Nama] — Slicing Form Component — ⚪
- [ ] Task: [Nama] — Apply Database Migration — ⚪
- [ ] Task: [Nama] — UI Documentation & Error Logging — ⚪
- [ ] Task: [Nama] — Create Reservation Table — ⚪
- [ ] Task: [Nama] — Setup React Hook Form & Zod — ⚪
...
- [ ] Task: [Nama] — Testing State Persistence — ⚪
- [ ] Task: [Nama] — Create Endpoint Get Room by ID — ⚪
- [ ] Task: [Nama] — Slicing Room Detail Component — ⚪
- [ ] Task: [Nama] — Design UI (Room Details) — ⚪
- [ ] Task: [Nama] — Setup Booking State Management — ⚪
- [ ] Task: [Nama] — Integrasi Tombol Find Rooms — ⚪
...
- [ ] Task: [Nama] — Success Redirect — ⚪
- [ ] Task: [Nama] — Apply Database Migration — ⚪
- [ ] Task: [Nama] — Design UI (Guest Form) — ⚪
- [ ] Task: [Nama] — UI Documentation & Error Logging — ⚪
- [ ] Task: [Nama] — Integrasi Submit & API State — ⚪
- [ ] Task: [Nama] — Testing Form Edge Cases — ⚪
- [ ] Task: [Nama] — Implement Database Transaction — ⚪
...
- [ ] Task: [Nama] — Setup Server-Side Validation (Zod) — ⚪
- [ ] Task: [Nama] — Setup React Hook Form & Zod — ⚪
- [ ] Task: [Nama] — Data Mapping & Validation Rules — ⚪
...
- Multi-bahasa (ID + EN)
- Promo/voucher code
- Channel manager OTA sync (out of scope V1)
- Dashboard Owner & Multi-Tenant/Infra — belum ada export Notion-nya, tambahin di sini kalau ada
